"""MCP protocol dataclasses and utilities.

This is the canonical location for MCP protocol definitions.
The top-level mcp_protocol.py re-exports from here for backward compatibility.
"""
